        ...
        <div class="container-xxl flex-grow-1 container-p-y loading">
            ...
            <h4 class="col-2 content">
                <strong class="content-main" id="amount">
                    &#8377;{{number_format($payments->payment_amount,2)}}
                </strong>
            </h4>
            <hr>
            <div class="row mt-3">
            ...
            <div class="col d-flex">
                <a href="{{url('student/payment/invoice?payment_intent='.$payments->payment_intent.'&date='.\Carbon\Carbon::parse($payments->created_at)->format('Y-M-d'))}}" class="btn btn-dark" data-toggle="tooltip" title="Download Invoice" id="download_invoice">
