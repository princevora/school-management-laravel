                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        ...
                        @if ($studentData->verification_status === 99)
                          <div class="card-body">
                            <h5 class="text-primary">Hello {{Str::title($student->student_name)}}🎉 !!</h5>
                            <p><strong>Your Standerd Was Deleted By The staff</strong> You Cannot Access The Dashboard Unless They Readd Your Standerd</p>
                            <hr>
                            <p>You May Cannot Receive Any Updates Or Tasks Etc.. And Some Of The Features Of the Dashboard Cannot Be Used.</p>
                          </div>
                        @else
                           <div class="card-body {{isset($task) && $task->count() > 0 ? 'bg-light text-secondary' : ''}}">
                            <h5 class="card-title text-primary">{{isset($task) && $task->count() > 0 ? 'A New Task Arrived For You '.$task->task_name.'' : 'Hello '.$student->student_name.'🎉'}}!</h5>
                            <p class="mb-4">
                            <strong>{{isset($task) ? 'Task : '.$task->task.'' : 'Welcome To The dashboard You Can privatly Use your dashboard And Edit or manage it.'}}&nbsp;</strong>
                            <hr>
                            School Tasks Will Be appeared here And New Updates too.
                            </p>

                          </div>
                        @endif
                      </div>
                      <div class="col-sm-5 text-center text-sm-lef">
