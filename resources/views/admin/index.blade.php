                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Congratulations {{Str::title($staffRole->staff_name)}}! 🎉</h5>
                          <p class="mb-4">
                            This Is Your Admin Dashboard For Manage The School and students..
                          </p>
                      ...
                      <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                          <img
                            src="{{url('../assets/img/illustrations/man-with-laptop-light.png')}}"                            height="140"
                            alt="View Badge User"
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title mb-2">&#8377;{{$earnings}}</h3>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title text-nowrap mb-1">&#8377;{{$transactions}}</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="d-block mb-1">Failed Payments</span>
                          <h3 class="card-title text-nowrap mb-2">&#8377;{{$failed}}</h3>
                        </div>
                      </div>
                    </div>
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Succeeded Payments</span>
                          <h3 class="card-title mb-2">&#8377;{{$succeeded}}</h3>
                        </div>
                      </div>
                    </div>
                    <!-- </div>
