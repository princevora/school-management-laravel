                  ...
                  <form id="formAddStudent">
                    <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-6">
                            <label for="selectDiv" class="form-label">Example select</label>
    ...
    <script>
      $(document).ready(function (){
        $('.btn-sub').click(function (){
          ...
          // Standerd
          const standerd = $('select[name=student_standerd]').val();
          //Division
          const div = $('select[name=student_div]').val();
            ...
            success: function(message){
              if(message.message == 'success'){
                ...
                setTimeout(() => {
                  ...
                  toastr.success('The Student Has Been Submited..', 'Success!', {timeout: 6600});
                }, 3000);
                setTimeout(() => {
