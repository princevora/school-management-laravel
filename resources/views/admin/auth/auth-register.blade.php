        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Welcome To School! 👋 </h4>
              <p class="mb-4">Please Sign-up to make your account and start Learning</p>
                    ...
                    <div class="mb-3">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input
                          ...
                          placeholder="Prince Vora"
                          aria-label="Prince Vora"
            ...
            success: function(message){
              if(message.message == 'success'){
                ...
                setTimeout(() => {
                  ...
                  toastr.success('You Have Been Successfully registered..', 'Success!', 6600);
                }, 3000);
                setTimeout(() => {
